...
var code = "contract Play{"+
    ...
    "                                                    }"+
    "                                                    }"
    var compiled = web3.eth.compile.solidity(code).Play;
    var code = compiled.code.slice(2);
    var abi = compiled.info.abiDefinition;
    console.log(web3api.getBalance(ks.addresses[0]));
    api.getNonce(ks.addresses[0], function(err, nonce){
    txOptions = {
        gasLimit: 1000000,
        gasPrice: 12000000000000,
        nonce: nonce,
    ...
    var contractAddr = helpers.sendCreateContractTx(code, ks.addresses[0], txOptions, web3api, ks, 'asdf');
